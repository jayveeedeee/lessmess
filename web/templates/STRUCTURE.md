...
| Entry | Purpose |
| --- | --- |
| `board.html` | Change board view with task columns and controls |
| `explorer.html` | Explorer page rendering the covered-directory tree and per-directory chat controls. |
